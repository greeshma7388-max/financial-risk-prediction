...
def main():
    ...
    for col in num_cols:
        if col != 'ID': # for skipping ID column
    ...
    plt.tight_layout()
    plt.savefig("genz_confusion_matrices.png")
    ...
    plt.tight_layout()
    plt.savefig("genz_feature_importances.png")
    ...
    # Therefore, they may not change entirely to a 'Low Risk' or 'Medium Risk' class immediately 
